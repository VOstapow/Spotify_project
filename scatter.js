$(document).ready(function() {
    ...
    var POINT_Y = 'weeks_on_chart'; // column name for y values in data.csv
    ...
    var X_AXIS = 'Total streams'; // x-axis label, label in tooltip
    var Y_AXIS = 'How many weeks On chart'; // y-axis label, label in tooltip
  
    var SHOW_GRID = true; // `true` to show the grid, `false` to hide
  
    // Read data file with random string generated by current time
    // to bypass browser cache, and create chart
    $.get('https://raw.githubusercontent.com/trvrbrdgs/Spotify_project/main/music-main/scatterPlot.csv', {'_': $.now()}, function(csvString) {
      ...
      var ctx = document.getElementById('scatter-container').getContext('2d');
